...
public class C5_Varargs04 {
	...
	public static void main(String[] args) {
		...
		int arr[]= {15,20,25};
		toplama(arr); // varargs array olark calisir ve argument olarak array yollanabilir
		
		//kullanicidan deger alarak varargs calistirmak istiyorsak
		//girilen degerleri bir array e kaydetmeliyiz
		//bunun icin kullanicidan aldigimiz degerleri esnek oldugu icin bir list e koyariz
